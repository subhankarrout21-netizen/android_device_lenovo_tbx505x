# android_device_lenovo_tbx505x
Device tree for Lenovo TB-X505X (OrangeFox/TWRP).
#
...
[README.md](https://github.com/user-attachments/files/22683009/README.md)
...
mka recoveryimage
```
[vendorsetup.sh](https://github.com/user-attachments/files/22683011/vendorsetup.sh)
#
# Copyright 2019 The Android Open Source Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
